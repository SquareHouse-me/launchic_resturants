...
class PastPendingReservation extends StatefulWidget {
  @override
  State<PastPendingReservation> createState() => _PastPendingReservationState();
}

class _PastPendingReservationState extends State<PastPendingReservation> {
        ...
        () {
          return eventController.pastReservationEventAppStatus.value == AppStatus.LOADING
              ...
              : eventController.pastReservationEventAppStatus.value == AppStatus.COMPLETED
                  ? eventController.pastPendingReservationList.value.isEmpty
                      ? Center(
                          child: Padding(
                          ...
                          child: AnimationLimiter(
                            child: DataTable(
                              ...
                              rows: eventController
                                  .pastPendingReservationList.value
                                  .map((rowData) {
                                String statusText =
