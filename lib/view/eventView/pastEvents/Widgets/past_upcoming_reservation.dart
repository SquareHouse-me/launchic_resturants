...
class PastUpComingReservation extends StatefulWidget {
  @override
  State<PastUpComingReservation> createState() =>
      _PastUpComingReservationState();
}

class _PastUpComingReservationState extends State<PastUpComingReservation> {
        ...
        () {
          return eventController.pastReservationEventAppStatus.value == AppStatus.LOADING
              ...
              : eventController.pastReservationEventAppStatus.value == AppStatus.COMPLETED
                  ? eventController.pastUpComingReservationList.value.isEmpty
                      ? Center(
                          child: Padding(
                          ...
                          child: AnimationLimiter(
                            child: DataTable(
                              ...
                              rows: eventController
                                  .pastUpComingReservationList.value
                                  .map((rowData) {
                                String statusText =
