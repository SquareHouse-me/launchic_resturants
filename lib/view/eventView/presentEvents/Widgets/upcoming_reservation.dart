...
class UpcomingReservationView extends StatefulWidget {
  @override
  State<UpcomingReservationView> createState() =>
      _UpcomingReservationViewState();
}

class _UpcomingReservationViewState extends State<UpcomingReservationView> {
        ...
        () {
          return eventController.reservationEventAppStatus.value == AppStatus.LOADING
              ...
              : eventController.reservationEventAppStatus.value == AppStatus.COMPLETED
                  ? eventController.upComingReservationList.value.isEmpty
                      ? Center(
                          child: Padding(
